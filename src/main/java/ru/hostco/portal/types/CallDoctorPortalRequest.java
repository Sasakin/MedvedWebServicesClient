...
import ru.hostco.types.CallDoctorRequest;
 ...
 * ������ � ���������� ������ �� ����� ����� �� ���
 * 
 * <p>Java class for CallDoctorPortalRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CallDoctorPortalRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.hostco.ru/types}CallDoctorRequest"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "CallDoctorPortalRequest", propOrder = {
    "callNumber",
    "muCode"
})
public class CallDoctorPortalRequest
    extends CallDoctorRequest
{
